        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <article>
            <div>
              ...
              <p
                className={`${errors.firstname ? "instruction" : "offscreen"}`}
              >
            ...
            <div>
              ...
              <p className={`${errors.lastname ? "instruction" : "offscreen"}`}>
            ...
            <div>
              ...
              <p className={`${errors.gender ? "instruction" : "offscreen"}`}>
            ...
            <div>
              ...
              <select name="AcadQual" id="AcadQual" {...register("AcadQual")}>
                <option value="">select an option</option>
              ...
              <p className={`${errors.AcadQual ? "instruction" : "offscreen"}`}>
            ...
            <div>
              ...
              <p className={`${errors.email ? "instruction" : "offscreen"}`}>
          ...
          <aside>
            ...
            <input type="checkbox" id="css" value="CSS" {...register("css")} />
