...
export { default as FullstackHero } from "./CourseHeroSections/FullstackHero";
export { default as ProductDesignHero } from "./CourseHeroSections/ProductDesignHero";
export { default as BlockchainDetails } from "./CourseDetails/BlockchainDetails";
